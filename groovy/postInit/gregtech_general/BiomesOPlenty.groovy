...
mods.gregtech.mixer.recipeBuilder().inputs(ore('poop'), metaitem('dustWood') * 2, ore('sand') * 4).fluidInputs(fluid('water') * 1000).outputs(metaitem('fertilizer')).duration(100).EUt(30).buildAndRegister()
