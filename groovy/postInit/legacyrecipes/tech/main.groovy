...
recipemap('macerator').recipeBuilder()
        .inputs(item('galacticraftcore:basic_block_moon', 4))
        .outputs(metaitem('dustMoonstone'))
...
recipemap('assembly_line').recipeBuilder()
        .stationResearch(b -> b.researchStack(item('gregtech:meta_item_1', 647)).CWUt(4))
...
recipemap('chemical_reactor').recipeBuilder()
        .inputs(ore('dustWood'))
        .fluidInputs(fluid('seedslurry') * 1000)
         .outputs(metaitem('dustPlantMatter'))
        .duration(220).EUt(120).buildAndRegister()
